    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <motion.div
                ...
                className={`flex items-center space-x-3 p-3.5 border rounded-xl transition-all ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {WHY_CHOOSE_US.map((item) => (
            <motion.div
              ...
              className={`p-8 border rounded-2xl transition-all duration-300 group shadow-lg cursor-pointer ${
                isDark 
        ...
        <motion.div
          ...
          className={`mt-14 border rounded-2xl p-8 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl ${
            isDark
        ...
        >
          ...
          <div className="flex items-center space-x-3 shrink-0 flex-wrap gap-2">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3.5 bg-[#071710] text-white font-semibold text-xs uppercase tracking-wider border border-emerald-500/40 rounded-xl hover:bg-[#0c2e1f] transition-all cursor-pointer"
            >
              Inquire Online
            </motion.button>
          </div>
